Public Class VarGlob
    ...
    Public Shared ConexionPrincipal As String = "Data Source=SERVER2008\SERVER12;Initial Catalog=SORGO;Persist Security Info=True;User ID=sa;Password=Usuario01" '***** CONEXION A SERVIDOR PRINCIPAL 
    '####################################################
